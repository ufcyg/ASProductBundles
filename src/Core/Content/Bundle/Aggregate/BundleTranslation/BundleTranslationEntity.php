...
namespace ASProductBundles\Core\Content\Bundle\Aggregate\BundleTranslation;

use ASProductBundles\Core\Content\Bundle\BundleEntity;
...
class BundleTranslationEntity extends TranslationEntity
{
    ...
    public function getBundle(): BundleEntity { return $this->bundle; }
